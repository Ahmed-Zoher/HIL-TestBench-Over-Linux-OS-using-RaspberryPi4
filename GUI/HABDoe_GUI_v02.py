...
"}")
    ...
    def retranslateUi(self, HABDoe):
        ...
        self.Channel7_Frequency_label.setText(QCoreApplication.translate("HABDoe", u"Frequency (Hz)", None))
        self.Channel7_DutyCycle_label.setText(QCoreApplication.translate("HABDoe", u"Duty Cycle (%)", None))
        self.Channel7_FrequencyRange_lineEdit.setText(QCoreApplication.translate("HABDoe", u"   Range: 0 -> 30,000,000", None))
        self.Channel8_groupBox.setTitle(QCoreApplication.translate("HABDoe", u"Channel 8", None))
        self.Channel8_Frequency_label.setText(QCoreApplication.translate("HABDoe", u"Frequency (Hz)", None))
        self.Channel8_DutyCycle_label.setText(QCoreApplication.translate("HABDoe", u"Duty Cycle (%)", None))
        self.Channel8_FrequencyRange_lineEdit.setText(QCoreApplication.translate("HABDoe", u"   Range: 0 -> 30,000,000", None))
        ...
        self.Server_Number_comboBox.setItemText(0, QCoreApplication.translate("HABDoe", u"Server #1", None))
        self.Server_Number_comboBox.setItemText(1, QCoreApplication.translate("HABDoe", u"Server #2", None))
        self.Server_Number_comboBox.setItemText(2, QCoreApplication.translate("HABDoe", u"Server #3", None))
